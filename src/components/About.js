...
export default function About() {
  return (
    <section className="about" id="about">
      ...
      <div className="aphorisms" id="aphorisms"><p>{aphorisms[Math.floor(Math.random() * aphorisms.length)]}</p><p><a className="fripp" href="https://www.dgmlive.com/" target="_blank" rel="noreferrer">- Robert Fripp</a></p></div>
